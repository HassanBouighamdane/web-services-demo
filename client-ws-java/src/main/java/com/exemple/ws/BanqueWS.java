 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.exemple.com/", wsdlLocation = "http://localhost:8088/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://ws.exemple.com/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.exemple.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.exemple.com/", "BanqueServicePort"), BanqueService.class, features);
    }
